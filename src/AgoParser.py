    ...
    def _call_stmt_(self):
        with self._choice():
            ...
            self._error(
                ...
                '<LBRACE> <LPAREN> <NULL> <ROMAN_NUMERAL>'
                '<STR_LIT> <TRUE> <identifier> <item>'
                '<lambda_decl> <literal_item> <mapstruct>'
    ...
    def _item_(self):
        with self._choice():
            ...
            self._error(
                ...
                '<LBRACE> <LPAREN> <NULL> <ROMAN_NUMERAL>'
                '<STR_LIT> <TRUE> <identifier> <item>'
                '<lambda_decl> <mapstruct>'
                '<nodotcall_stmt> [0-9]*\\.[0-9]+ [0-9]+'
                '[A-Za-z_][A-Za-z_0-9]* [MCDLXIV]+'
            )
